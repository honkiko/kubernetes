...
func (self *QCloud) InstanceExistsByProviderID(providerID string) (bool, error) {
	return true, nil
}
...
func (self *QCloud)  GetZoneByProviderID(providerID string) (cloudprovider.Zone, error) {
	return cloudprovider.Zone{}, nil
}

func (self *QCloud)  GetZoneByNodeName(nodeName types.NodeName) (cloudprovider.Zone, error) {
	return cloudprovider.Zone{}, nil
}